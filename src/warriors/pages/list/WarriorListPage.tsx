      ...
      {!isLoading && pageResponse && (
        <>
          <WarriorFilter
            ...
            handleSetDefault={() => {
              if (pageResponse.results) setFilterWarriors([...pageResponse.results]);
            }}
          ...
          <CardsContainer>
            ...
            >
              {filterWarriors &&
                filterWarriors.length > 0 &&
                filterWarriors.map((warrior) => <WarriorCard key={warrior.name} warrior={warrior} />)}
            </InfiniteScroll>
          </CardsContainer>
        </>
      )}
